# translations.py - App Translations for ReliaChat
# This script defines translations used by the ReliaChat application.
# These translations are for the app interface elements and do not cover user inputs or AI responses.
#

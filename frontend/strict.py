...
def strict_content(content):
    ...
    blocked_words = [
        ...
        "die faggots", "die child", "How to terrorise children?", "How to build bomb", "how to fuck an animal", "fucking animals",
        "democrats suck", "politics suck", "republikans suck", "anti lgbt", "child labor",
